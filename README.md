...
Bootstrap v5.3.2: A robust front-end framework used extensively for responsive layouts, components, and utility classes.
Font Awesome: Integrated for scalable vector icons (v6.0.0 link observed).
...
> Team D
  > images
  - about-ayurveda-ayatanam.html
  - about-dr-tejas-bharadwaj.html
  - JS About.js
  - JS Aboutus
  - .gitattributes
  - consult.html
...
Specific directories for team-based contributions and modules.
